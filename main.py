...
T, V = RegressionLoaders(os.path.join(where, 'sample_data'))
...
shutil.rmtree(os.path.join(where, 'sample_data/train'))
shutil.rmtree(os.path.join(where, 'sample_data/val'))
